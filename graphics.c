/* Uncomment to disable graphics.  Lets you compile and run on machines  *
 * without X Windows (like Windows NT) but of course, without graphics.  */
/* #define NO_GRAPHICS */  
#include <math.h>
#include <stdlib.h>
#include <stdio.h>
 ...
 * Electrical and Computer Engineering.  Graphics package  Version 1.4.     *
...
/* Safe malloc and realloc below (exit if they're unsuccessful). */
...
/* Use proper point-size medium-weight upright helvetica font */
 ...
 //      pointsize); 
 sprintf(fontname,"-*-helvetica-medium-r-*-*-20-*-100-100-*-*-iso8859-1"); 
